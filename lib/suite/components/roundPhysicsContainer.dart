...
import 'package:first_math/suite/components/scaledCenteredPolygon.dart';
...
class RoundPhysicsContainer extends BodyComponent<SuiteGame>
  ...
  void render(Canvas canvas) {
    ...
    //   // Create a green paint
    //   final greenPaint = Paint()..color = Colors.green;

    //   // Draw a filled green circle as the background
    //   canvas.drawCircle(Vector2.zero().toOffset(), radius, greenPaint);
  }
}
